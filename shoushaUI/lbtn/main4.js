app.import(function(lib, game, ui, get, ai, _status, app) {
	...
	lib.arenaReady.push(function() {
		...
		head.style.cssText =
			"cursor: pointer;display: block;--w: 80px;--h: calc(var(--w) * 81/247);width: var(--w);height: var(--h)+4px;position: absolute;top: calc(100% - 70px);left: calc(100% - 360px);background-color: transparent;z-index:4"
		...
		precontent() {
			Object.assign(game.videoContent, {
				...
				updateCardRoundTime(opts) {
					...
					ui.cardRoundTime.node.roundNumber.innerHTML = '<span>' + game
						.roundNumber + '</span>';
