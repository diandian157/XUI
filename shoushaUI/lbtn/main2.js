app.import(function(lib, game, ui, get, ai, _status, app) {
	...
	lib.arenaReady.push(function() {
		...
		head.style.cssText =
			"cursor: pointer;display: block;--w: 50px;--h: calc(var(--w) * 81/247);width: var(--w);height: var(--h)+4px;position: absolute;top: calc(100% - 40px);left: calc(100% - 360px);background-color: transparent;z-index:4"
			...
			handcardNumber: function() {
				...
				if (lib.config.extension_十周年UI_XPJ == "on") {
					...
					node8.listen(function(e) {
					    ...
					    // 更新背景
					    ui.background.style.backgroundImage = `url('${backgroundList[currentBgIndex]}')`;
