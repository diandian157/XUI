app.import(function (lib, game, ui, get, ai, _status, app) {
  ...
  lib.arenaReady.push(function () {
    ...
    head.style.cssText = "display: block;--w: 50px;--h: calc(var(--w) * 81/247);width: var(--w);height: var(--h)+4px;position: absolute;top: calc(100% - 40px);left: calc(100% - 360px);background-color: transparent;z-index:4"
